...
const PARTE_A_PRIVILEGIO: Partial<Record<ParteTipo, keyof Privilegios>> = {
  ...
  aux_estudiante_1: 'estudiante_aux_conversacion', aux_estudiante_2: 'estudiante_aux_conversacion',
  aux_estudiante_3: 'estudiante_aux_conversacion', aux_estudiante_4: 'estudiante_aux_conversacion',
